...
@app.route('/')
def home():
    return render_template('main.html', name='Monty')
...
# to the 'user' variable and send that user name into the html file. If it doesn't have any parameter, warning massage will show up
