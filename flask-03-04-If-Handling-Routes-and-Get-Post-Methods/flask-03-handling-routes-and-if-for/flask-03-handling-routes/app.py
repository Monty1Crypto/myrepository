...
@app.route('/admin')
def admin():
    return redirect(url_for('error'))           #redirect to url_for ...
...
# Create a function named greet_admin which redirect the request to the greet path (name function above) with param of 'Master Admin!!!!' 
